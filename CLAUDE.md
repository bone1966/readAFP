...
specimens; page overlays (BMO/EMO + IPO); `__version__ = "1.0.0"` shown in
the About modal with the live Python version. Landing page bundles 6
sample cards (PTOCA / GOCA / IOCA / FOCA / BCOCA / overlay), each
generated by a `tools/make_*_sample.py` script.
